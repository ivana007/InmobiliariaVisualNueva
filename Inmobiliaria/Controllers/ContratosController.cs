...
namespace Inmobiliaria.Controllers
{
    ...
    public class ContratosController : Controller
    {
        ...
        public ActionResult BuscarVigentesPorFecha()
        {
        ...
        public ActionResult BuscarPorInmuebles()
        {
            List<Contrato> contratos = new List<Contrato>();
            ViewBag.Inmuebles = repositorioInmueble.ObtenerDisponibles();
            ViewBag.Cartel = "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult BuscarPorInmuebles(Inmueble inmueble)
        {
            try
            {
                // TODO: Add insert logic here
                var res = repositorioContrato.ObtenerPorInmueble(inmueble.IdInmueble);
                if(res!=null)
                {
                    ViewBag.Inmuebles = repositorioInmueble.ObtenerDisponibles();
                    return View(res);
                ...
                {
                    ViewBag.Cartel = "NO Posee Contrato";
